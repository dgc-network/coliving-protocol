...
> `{__name__="primary_user_count", component="network-monitoring", endpoint="https://creatornode5.staging.coliving.co", environment="stage", exported_job="network-monitoring", host="discoveryprovider2.staging.coliving.co", instance="35.202.199.159:9091", job="stage-network-monitoring", run_id="9", service="coliving"}`
...
GRAFANA_API_URL=grafana.coliving.co \
GRAFANA_PASS=xxx \
./grafana/bin/save-dashboards.sh
```
