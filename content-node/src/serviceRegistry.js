...
class ServiceRegistry {
  constructor() {
    ...
    this.prometheusRegistry = new PrometheusRegistry() // Service that digitalContents metrics
    ...
    this.transcodingQueue = TranscodingQueue // Transcodes and segments all digitalContents
