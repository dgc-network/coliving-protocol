...
// userId (owner of the content favorited), type (agreement/album/content list), and entityId (agreementId, ect)
 ...
 * for the owner of the favorited agreement/content list/album
...
async function processFavoriteNotifications (notifications, tx) {
  ...
  // This is used if there are multiple favorites of the same agreement,
  ...
  // Favorite - userId=notif target, entityId=agreement/album/repost id, actionEntityType=User actionEntityId=user who favorited
