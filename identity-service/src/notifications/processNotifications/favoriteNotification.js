...
// userId (owner of the content favorited), type (digital_content/album/contentList), and entityId (digitalContentId, ect)
 ...
 * for the owner of the favorited digital_content/contentList/album
...
async function processFavoriteNotifications (notifications, tx) {
  ...
  // This is used if there are multiple favorites of the same digital_content,
  ...
  // Favorite - userId=notif target, entityId=digital_content/album/repost id, actionEntityType=User actionEntityId=user who favorited
