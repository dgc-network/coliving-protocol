...
var snippetMap = (_snippetMap = {}, _defineProperty(_snippetMap, _constants.notificationTypes.Favorite.base, function (notification) {
  ...
  return "".concat(notification.contentListOwner.name, " added ").concat(notification.agreement.title, " to ").concat(notification.contentList.content_list_name);
...
var Body = function Body(props) {
  ...
  }, "See more on Coliving")))))), /*#__PURE__*/_react["default"].createElement("tr", null, /*#__PURE__*/_react["default"].createElement("td", {
    style: {
      paddingBottom: '25px'
    }
