 ...
 */
async function processTrendingTracks (colivingLibs, blocknumber, trendingTracks, tx) {
  const now = moment()
...
async function indexTrendingTracks (colivingLibs, optimizelyClient, tx) {
  try {
    ...
    await processTrendingTracks(colivingLibs, blocknumber, trendingTracks, tx)
  } catch (err) {
