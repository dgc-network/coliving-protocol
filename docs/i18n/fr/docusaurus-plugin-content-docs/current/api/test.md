...
<h3 id="get-user's-favorite-agreements-parameters">Paramètres de requête</h3>
...
<h3 id="get-user's-favorite-agreements-responses">Réponses</h3>
...
<h3 id="get-user's-most-used-agreement-tags-parameters">Paramètres de requête</h3>
...
<h3 id="get-user's-most-used-agreement-tags-responses">Réponses</h3>
...
<h3 id="get-user's-agreements-parameters">Paramètres de requête</h3>
...
<h3 id="get-user's-agreements-responses">Réponses</h3>
...
<h1 id="api-contentLists">contentLists</h1>

## Recherche de contentList
...
*Rechercher une contentList*

<h3 id="search-contentLists-parameters">Paramètres de requête</h3>
...
<h3 id="search-contentLists-responses">Réponses</h3>

| Status | Meaning                                                                    | Description  | Schema                                                    |
| ------ | -------------------------------------------------------------------------- | ------------ | --------------------------------------------------------- |
| 200    | [OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)                    | none         | [contentList_search_result](#schemacontentList_search_result) |
| 400    | [Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)           | Bad request  | None                                                      |
| 500    | [Internal Server Error](https://tools.ietf.org/html/rfc7231#section-6.6.1) | Server error | None                                                      |

## ContentLists populaires
...
*Obtenez les contentLists les plus populaires pour une période donnée sur Coliving*

<h3 id="trending-contentLists-parameters">Paramètres de requête</h3>
...
<h3 id="trending-contentLists-responses">Réponses</h3>

| Status | Meaning                                                                    | Description  | Schema                                                              |
| ------ | -------------------------------------------------------------------------- | ------------ | ------------------------------------------------------------------- |
| 200    | [OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)                    | Success      | [trending_contentLists_response](#schematrending_contentLists_response) |
| 400    | [Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)           | Bad request  | None                                                                |
| 500    | [Internal Server Error](https://tools.ietf.org/html/rfc7231#section-6.6.1) | Server error | None                                                                |

## Récupérer la contentList
...
*Récupérer une contentList*

<h3 id="get-contentList-parameters">Paramètres de requête</h3>

| Name        | Type   | Required | Description   |
| ----------- | ------ | -------- | ------------- |
| contentList_id | string | true     | A ContentList ID |
...
<h3 id="get-contentList-responses">Réponses</h3>

| Status | Meaning                                                                    | Description  | Schema                                        |
| ------ | -------------------------------------------------------------------------- | ------------ | --------------------------------------------- |
| 200    | [OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)                    | none         | [contentList_response](#schemacontentList_response) |
| 400    | [Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)           | Bad request  | None                                          |
| 500    | [Internal Server Error](https://tools.ietf.org/html/rfc7231#section-6.6.1) | Server error | None                                          |
...
<h3 id="get-contentList-agreements-parameters">Paramètres de requête</h3>
...
<h3 id="get-contentList-agreements-responses">Réponses</h3>

| Status | Meaning                                                                    | Description  | Schema                                                        |
| ------ | -------------------------------------------------------------------------- | ------------ | ------------------------------------------------------------- |
| 200    | [OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)                    | none         | [contentList_agreements_response](#schemacontentList_agreements_response) |
| 400    | [Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)           | Bad request  | None                                                          |
| 500    | [Internal Server Error](https://tools.ietf.org/html/rfc7231#section-6.6.1) | Server error | None                                                          |

<h1 id="api-agreements">pistes</h1>
...
<h3 id="get-agreement-by-handle-and-slug-parameters">Paramètres de requête</h3>
...
<h3 id="get-agreement-by-handle-and-slug-responses">Réponses</h3>
...
<h3 id="recommended-agreements-parameters">Paramètres de requête</h3>
...
<h3 id="recommended-agreements-responses">Réponses</h3>
...
<h3 id="search-agreements-parameters">Paramètres de requête</h3>
...
<h3 id="search-agreements-responses">Réponses</h3>
...
<h3 id="trending-agreements-parameters">Paramètres de requête</h3>
...
<h3 id="trending-agreements-responses">Réponses</h3>
...
<h3 id="get-agreement-parameters">Paramètres de requête</h3>
...
<h3 id="get-agreement-responses">Réponses</h3>
...
<h3 id="stream-agreement-parameters">Paramètres de requête</h3>

| Name     | Type   | Required | Description |
| -------- | ------ | -------- | ----------- |
| agreement_id | string | true     | A Agreement ID  |

<h3 id="stream-agreement-responses">Réponses</h3>
...
*Résout et redirige l'URL de l'application Coliving fournie vers l'URL de la ressource API qu'elle représente*

Ce endpoint vous permet de rechercher et d'accéder aux ressources de l'API lorsque vous ne connaissez que l'URL .co. Les pistes, les listes de lecture et les utilisateurs sont pris en charge.
...
| contentList_count  | integer                                   | true     | none         | none        |
...
<a id="tocscontentList_response"></a>
<h2 id="tocS_contentList_response">contentList_response</h2>
...
<a id="tocscontentList"></a>
<h2 id="tocS_contentList">contentLists</h2>
...
| Name               | Type                                        | Required | Restrictions | Description |
| ------------------ | ------------------------------------------- | -------- | ------------ | ----------- |
| artwork            | [contentList_artwork](#schemacontentList_artwork) | false    | none         | none        |
| description        | string                                      | false    | none         | none        |
| id                 | string                                      | true     | none         | none        |
| is_album           | boolean                                     | true     | none         | none        |
| contentList_name      | string                                      | true     | none         | none        |
| repost_count       | integer                                     | true     | none         | none        |
| favorite_count     | integer                                     | true     | none         | none        |
...
<a id="tocscontentList_agreements_response"></a>
<h2 id="tocS_contentList_agreements_response">contentList_agreements_response</h2>
...
<a id="tocscontentList_search_result"></a>
<h2 id="tocS_contentList_search_result">contentList_search_result</h2>
...
<a id="tocstrending_contentLists_response"></a>
<h2 id="tocS_trending_contentLists_response">trending_contentLists_response</h2>
