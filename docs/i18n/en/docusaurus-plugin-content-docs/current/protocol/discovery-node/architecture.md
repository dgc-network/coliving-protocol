...
ETL code for the Elastic Search layer is found in the [es-indexer](https://github.com/AudiusProject/-protocol/tree/master/discovery-provider/es-indexer).