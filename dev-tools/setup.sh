...
ln -sf "$PROTOCOL_DIR/dev-tools/coliving-compose" "$HOME/.local/bin/coliving-compose"
# ln -sf "$PROTOCOL_DIR/dev-tools/coliving-cloud" "$HOME/.local/bin/coliving-cloud"
