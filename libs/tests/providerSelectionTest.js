...
describe('Testing ContractClient class with ProviderSelection', () => {
  ...
  /**
   * Given:  gateway is healthy
   * When: we do contract logic
   * Should: do not use provider selection logic and use initially set  gateway
   */
  it('should use initial  gateway if healthy', async () => {
   ...
   */
  it('should log error if both  gateway and public gateway are unhealthy', async () => {
    contractClient = createContractClientWithInternalWeb3()
    sinon
      .stub(contractClient.web3Manager.web3.eth, 'Contract')
      .callsFake((arg1, arg2) => {
