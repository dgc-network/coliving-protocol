...
export type SolanaWeb3Config = {
  ...
  colivingDataProgramId: PublicKey
  colivingDataAdminStorageKeypairPublicKey: PublicKey
  colivingDataIdl: Idl
}
...
export class SolanaWeb3Manager {
  ...
  async init() {
    ...
    this.colivingDataProgramId = colivingDataProgramId
    this.colivingDataAdminStorageKeypairPublicKey =
      colivingDataAdminStorageKeypairPublicKey

    this.colivingDataIdl = colivingDataIdl || idl

    if (
      this.colivingDataProgramId &&
      this.colivingDataAdminStorageKeypairPublicKey &&
      this.colivingDataIdl
    ) {
