...
export const ETH_PROVIDER_URLS = 'https://eth.coliving.co'
...
export const IDENTITY_SERVICE_ENDPOINT = 'https://identityservice.coliving.co'
export const REGISTRY_ADDRESS = '0xC611C82150b56E6e4Ec5973AcAbA8835Dd0d75A2'
export const WEB3_PROVIDER_URL = 'https://poa-gateway.coliving.co'
