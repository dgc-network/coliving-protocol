...
function setup_profile() {
    ...
    echo 'export PROTOCOL_DIR=$HOME/coliving-protocol' >>$HOME/.profile
    echo 'export COLIVING_REMOTE_DEV_HOST=$(curl -sfL -H "Metadata-Flavor: Google" http://metadata/computeMetadata/v1/instance/network-interfaces/0/access-configs/0/external-ip)' >>$HOME/.profile
