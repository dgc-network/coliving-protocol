...
SPL_TOKEN_PROGRAM = shared_config["solana"]["wei_digitalcoin_mint"]
...
def cache_latest_spl_digitalcoin_db_tx(redis: Redis, latest_tx: CachedProgramTxInfo):
...
def parse_sol_tx_batch(
    ...
    with db.scoped_session() as session:
        ...
        if tx_sig_batch_records:
            ...
            cache_latest_spl_digitalcoin_db_tx(
                redis,
                {
