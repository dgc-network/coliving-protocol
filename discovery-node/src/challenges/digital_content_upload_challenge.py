...
class DigitalContentUploadChallengeUpdater(ChallengeUpdater):
    ...
    def _get_num_digital_content_uploads_by_user(
        ...
        num_digital_contents_per_user = Counter(map(lambda t: t.owner_id, digitalContents))
        return num_digital_contents_per_user


digital_content_upload_challenge_manager = ChallengeManager(
    "digital-content-upload", DigitalContentUploadChallengeUpdater()
)
