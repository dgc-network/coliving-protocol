    ...
    try:
        ...
        for user_id, mh in user_mh.items():
            ...
            for other_id in similar:
                ...
                # https://github.com/AudiusProject/audius-protocol/blob/ddda462014ecdfd588f2834d07bf0a6066c56487/discovery-node/src/queries/get_related_artists.py#L95-L98
