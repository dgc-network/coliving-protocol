...
from src.api.v1.content lists import full_ns as full_content lists_ns
...
api_v1.add_namespace(content lists_ns)
...
api_v1_full.add_namespace(full_content lists_ns)
