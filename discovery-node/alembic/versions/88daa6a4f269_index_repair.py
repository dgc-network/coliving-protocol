...
def upgrade():
    ...
    CREATE INDEX IF NOT EXISTS content_list_owner_id_idx ON contentLists (content_list_owner_id);


    drop index if exists content_list_created_at_idx;
    CREATE INDEX IF NOT EXISTS content_list_created_at_idx ON contentLists (created_at);
...
def downgrade():
    ...
    # https://github.com/dgc-network/coliving-protocol/blob/master/discovery-node/alembic/versions/d321f0a00721_partial_indexes.py
    #
