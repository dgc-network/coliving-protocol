...
def upgrade():
    op.create_table(
        ...
        # there is no unique constraint on digitalContents.digital_content_id
        # sa.ForeignKeyConstraint(['parent_digital_content_id'], ['digitalContents.digital_content_id'], ),
        # sa.ForeignKeyConstraint(['child_digital_content_id'], ['digitalContents.digital_content_id'], ),
