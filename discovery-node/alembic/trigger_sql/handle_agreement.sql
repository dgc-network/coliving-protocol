...
begin
  ...
  select * into old_row from agreements where is_current = false and digital_content_id = new.digital_content_id order by blocknumber desc limit 1;
...
drop trigger if exists on_digital_content on agreements;
