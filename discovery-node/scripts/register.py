...
def main():
    w3 = web3.Web3(web3.Web3.HTTPProvider(os.getenv("coliving_web3_eth_provider_url")))
    w3.eth.default_account = os.getenv("coliving_delegate_owner_wallet")

    registry = w3.eth.contract(
        address=os.getenv("coliving_eth_contracts_registry"),
    ...
    token = w3.eth.contract(
        address=os.getenv("coliving_eth_contracts_token"),
    ...
    discprov_url = os.getenv("coliving_discprov_url")
    ...
    serviceProviderFactory.functions.register(
        b"discovery-node",
        os.getenv("coliving_discprov_url"),
        200000 * (10 ** token.functions.decimals().call()),
        os.getenv("coliving_delegate_owner_wallet"),
    ).transact()
