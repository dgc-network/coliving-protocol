...
\$outchannel server_log,/var/log/discprov-server.log, 52428800,/audius-discovery-node/scripts/rotate-log.sh
\$outchannel worker_log,/var/log/discprov-worker.log, 52428800,/audius-discovery-node/scripts/rotate-log.sh
\$outchannel beat_log,/var/log/discprov-beat.log, 52428800,/audius-discovery-node/scripts/rotate-log.sh
