...
def test_search(args):
        ...
        for entity in entities:
            print(
                ...
                [
                    entity["user"]["handle"],
                    entity["user"]["name"],
                    entity.get("title") or entity.get("contentList_name"),
    ...
    if search_type == "contentLists" or search_type == "all":
        print_entity("contentLists", found["contentLists"])
        print_entity("saved_contentLists", found["saved_contentLists"])
