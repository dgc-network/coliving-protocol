...
def test_search(args):
        ...
        for entity in entities:
            print(
                ...
                [
                    entity["user"]["handle"],
                    entity["user"]["name"],
                    entity.get("title") or entity.get("content_list_name"),
    ...
    if search_type == "content_lists" or search_type == "all":
        print_entity("content_lists", found["content_lists"])
        print_entity("saved_content_lists", found["saved_content_lists"])
