...
def test_digital_content_upload_challenge(app):
    ...
    digitalContent1 = DigitalContent(
        blockhash="0x1",
        blocknumber=1,
        txhash="xyz",
        owner_id=1,
    ...
    digitalContent2 = DigitalContent(
        blockhash="0x2",
    ...
    digitalContent3 = DigitalContent(
        blockhash="0x3",
    ...
    digitalContent4 = DigitalContent(
        blockhash="0x3",
        blocknumber=30000001,
        txhash="abc",
        owner_id=1,
    ...
    with db.scoped_session() as session:
        ...
        # Ensure unlisted digitalContents and stems are not counted
        ...
        session.add(digitalContent3)
        bus.dispatch(ChallengeEvent.digital_content_upload, 30000001, 1)
        session.add(digitalContent4)
        bus.dispatch(ChallengeEvent.digital_content_upload, 30000001, 1)
        bus.flush()
        bus.process_events(session)
        user_challenge = digital_content_upload_challenge_manager.get_user_challenge_state(
