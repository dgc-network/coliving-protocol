...
def test_first_contentList_challenge(app):
    ...
    with db.scoped_session() as session:
        ...
        session.query(Challenge).filter(Challenge.id == "first-contentList").update(
        ...
        state = first_contentList_challenge_manager.get_user_challenge_state(
            session, ["1"]
        )[0]
