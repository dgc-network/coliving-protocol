...
def test_get_digital_contents_by_date(app):
    ...
    with db.scoped_session() as session:
        agreements = _get_digital_contents(
            session, {"user_id": 1287289, "offset": 0, "limit": 10, "sort": "date"}
        )

        assert len(agreements) == 5
        assert agreements[0]["digital_content_id"] == 1
        assert agreements[1]["digital_content_id"] == 3
        assert agreements[2]["digital_content_id"] == 5
        assert agreements[3]["digital_content_id"] == 4
        assert agreements[4]["digital_content_id"] == 2

        assert agreements[0]["permalink"] == "/some-test-user/digital-content-1"
        assert agreements[4]["permalink"] == "/some-test-user/digital-content-2"
...
def test_get_digital_contents_by_date_authed(app):
    ...
    with db.scoped_session() as session:
        ...
        assert agreements[0]["digital_content_id"] == 1
        assert agreements[1]["digital_content_id"] == 11
        assert agreements[2]["digital_content_id"] == 3
        assert agreements[3]["digital_content_id"] == 5
        assert agreements[4]["digital_content_id"] == 4
        assert agreements[5]["digital_content_id"] == 2
...
def test_get_digital_content_by_route(app):
    ...
    with app.app_context():
        ...
        with db.scoped_session() as session:
            ...
            assert len(agreements) == 1, "digital-content-1 is found for some-test-user"
            ...
            assert len(agreements) == 1, "digital-content-1 is still found for some-other-user"
            assert agreements[0]["owner_id"] == 4
            assert agreements[0]["permalink"] == "/some-other-user/digital-content-1"
            ...
            assert agreements[0]["owner_id"] == 4
            assert agreements[0]["permalink"] == "/some-other-user/hidden-digital-content"
...
def test_get_remixable_digital_contents(app):
    ...
    with app.app_context():
        ...
        agreements = get_remixable_digital_contents({"with_users": True})
